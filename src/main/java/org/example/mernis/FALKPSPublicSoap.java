...
public class FALKPSPublicSoap
{
    ...
    public FALKPSPublicSoap(){}

    public FALKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FALKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FALExtendedSoapSerializationEnvelope envelope= new FALExtendedSoapSerializationEnvelope(FALExtendedSoapSerializationEnvelope.VER11);
