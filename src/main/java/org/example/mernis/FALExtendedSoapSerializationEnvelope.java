...
class FALSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class FALExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(FALDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new FALStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static FALDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static FALDateTimeConverter dateTimeConverter = new FALStandardDateTimeConverter();

    public FALExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FALExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FALMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FALHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FALExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FALHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
